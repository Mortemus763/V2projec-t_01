...
import { updateSpot } from '../../store/spot'; // Ensure you have an updateSpot action in your Redux store
...
function UpdateSpot() {
  ...
  const [loading, setLoading] = useState(true); // To indicate when data is being fetched
